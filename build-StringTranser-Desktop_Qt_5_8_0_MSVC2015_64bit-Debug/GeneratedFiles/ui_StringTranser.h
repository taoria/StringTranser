...
public:
    ...
    void setupUi(QMainWindow *StringTranserClass)
    {
        ...
        StringTranserClass->resize(257, 453);
        ...
        pushButton_2->setGeometry(QRect(80, 330, 75, 23));
    ...
    void retranslateUi(QMainWindow *StringTranserClass)
    {
        ...
        pushButton_2->setText(QApplication::translate("StringTranserClass", "\347\224\237\346\210\220\345\255\227\347\254\246\347\224\273", Q_NULLPTR));
